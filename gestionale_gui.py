...
GUADAGNO_PERC = 0.3   # Guadagno 30%
TASSE_PERC = 0.3      # Tasse 30%
INVERSIONE_BATTUTA = 50
MONTAGGIO = 120
GUADAGNO_MINIMO = 300  # Guadagno minimo garantito
...
def calcola():
    ...
    guadagno_calcolato = totale_senza_tasse * GUADAGNO_PERC
    guadagno = max(guadagno_calcolato, GUADAGNO_MINIMO)
    ...
    if guadagno > guadagno_calcolato:
